...
from typing import Any, ClassVar, Optional, TypeVar, Union, Type, Dict, List, Iterable, Tuple
...
from stable_baselines3.common import util
...
from stable_baselines3.common.util import (
    FloatSchedule,
...
class BaseAlgorithm(ABC):
    ...
    def _update_learning_rate(self, optimizers: Union[List[th.optim.Optimizer], th.optim.Optimizer]) -> None:
        ...
        # self.custom_logger.log("train/learning_rate", self.lr_schedule(self._current_progress_remaining), self.num_timesteps)
    ...
    def _setup_learn(
        ...
        # util.configure_logger(self.verbose, self.tensorboard_log, tb_log_name, reset_num_timesteps)
