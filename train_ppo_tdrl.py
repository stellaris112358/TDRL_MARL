...
@hydra.main(config_path='conf', config_name='ppo_tdrl', version_base=None)
def main(cfg: DictConfig):
    ...
    model = PPO_REWARD(
        ...
        num_interaction= cfg.num_interact,
        reward_update=cfg.reward_update,
        return_update=cfg.return_update,
        metaworld_flag=metaworld_flag,
        unsuper_step=cfg.unsuper_step,
        unsuper_n_epochs=cfg.unsuper_n_epochs,
        size_segment=cfg.size_segment,
    ...
    model.learn(total_timesteps=cfg.num_train_steps, unsuper_flag=1)
    model.reward_model.save(work_dir, cfg.num_train_steps)
